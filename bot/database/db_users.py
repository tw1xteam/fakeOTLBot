...
class UserModel(BaseModel):
    ...
    refferal_count: int  # Количество рефералов
    sucessful_deals: int  # Успешных сделок
    user_ton_wallet: str | None  # TON Кошелек пользователя
    user_card_wallet: str | None  # Карта пользователя
...
class Userx:
    ...
    def add(
        ...
        user_ton_wallet = None
        user_card_wallet = None
        user_unix = get_unix()
        refferal_count = 0
        sucessful_deals = 0
